...
class SuppliersController extends \BaseController {
    ...
    public function addSupplier() {
        $param = [];
        $param['title'] = " | Add Employer Data";
        return View::make('admin.suppliers.addSupplier')->with($param);
    }

    /**Edit Supplier Data*/
    public function editSupplier() {
        $param = [];
        $param['title'] = " | Edit Employer Data";
        return View::make('admin.suppliers.editSupplier')->with($param);
    }
