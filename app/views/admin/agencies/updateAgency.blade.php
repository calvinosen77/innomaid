      ...
      <section id="main-content">
          <section class="wrapper">
            <header class="panel-heading">
              ...
              <!-- page start-->
            <form role="form" method="post" action="{{ URL::route('admin.agency.doupdateAgency') }}" id="updateAgencyForm" name="updateAgencyForm" enctype="multipart/form-data">
              <input type="hidden" id="id" name="id" value="{{ $agencyInform->id }}">
              <div class="row">
                          ...
                          <div class="panel-body bio-graph-info">
                              <div class="row">
                                  <div class="form-group clearfix">
                                      ...
                                      <div class="col-lg-6">
                                          <input id="company_name" name="company_name" type="text" value="{{ $agencyItem->company_name }}" class="validate epad form-control" required>
                                      </div>
                                  </div>
                                  <div class="form-group clearfix">
                                      <label class="col-lg-3 control-label " for="company_no">Company No.</label>
                                      <div class="col-lg-6">
                                          <input id="company_no" name="company_no" type="text" value="{{ $agencyItem->company_no }}" class="validate epad form-control" required>
                                      </div>
                                  </div>
                                  <div class="form-group clearfix">
                                      <label class="col-lg-3 control-label " for="address">Address</label>
                                      <div class="col-lg-6">
                                          <input id="address" name="address" type="text" value="{{ $agencyItem->address }}" class="validate epad form-control" required>
                                      </div>
                                  </div>
                                  <div class="form-group clearfix">
                                      <label class="col-lg-3 control-label " for="phone_number">Phone Number</label>
                                      <div class="col-lg-6">
                                          <input id="phone_number" name="phone_number" type="tel" value="{{ $agencyItem->phone_number }}" class="validate epad form-control" required>
                                      </div>
                                  </div>
                                  <div class="form-group clearfix">
                                      <label class="col-lg-3 control-label " for="email">Email</label>
                                      <div class="col-lg-6">
                                          <input id="email" name="email" type="email" value="{{ $agencyInform->email }}" class="validate epad form-control" required>
                                      </div>
                                  </div>
                                  <div class="form-group clearfix">
                                  ...
                                  <div class="form-group clearfix">
                                      ...
                                      <div class="row m-bot15">
                                          <div class="col-sm-6 text-center">
                                              <input type="checkbox" class="form-control" id="active" name="active" value="1" style="width: 25px;" {{ ($agencyInform->active == 1)? 'checked': '' }}/>
                                          </div>
                                      </div>
                                      </div>
                                  </div>
