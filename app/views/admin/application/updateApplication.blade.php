                      ...
                      <section class="panel">
                          ...
                          <!--//end -->
                            <div class="panel-body">
                              ...
                              <form id="wizard-validation-form" action="{{ URL::route('admin.maidapplication.doupdateApplication') }}" method="post" role="form" class="form-login margin-top-normal" enctype="multipart/form-data">
                                  ...
                                  <div>
                                      <div class="form-group clearfix" id="wrap_selectEmployer">
                                          ...
                                          <div class="col-lg-5">
                                              <select name="employer_id" class="required form-control" onchange="getEmployerData(this.value);" disabled>
                                                   <option value="">-- Select Employer -- </option>
                                                @foreach($employerinform_data as $item)
                                                    <option value="{{ $item->id }}" {{ ($applicationitem_data->employer_id==$item->id)? 'selected': '' }}>{{ $item->first_name . ' ' . $item->last_name }}</option>
                                                @endforeach
                                              </select>
                                              <input type="hidden" name="employer_id" value="{{ $applicationitem_data->employer_id }}">
                                          </div>
                                      </div>
<!-- Part A -->
    ...
    <!-- purpose -->                  <div class="row">
                                        <div class="col-lg-10">
                                          ...
                                          <div class="form-group clearfix">
                                              ...
                                              <div class="col-lg-6">
                                                  <select id="purpose" name="purpose" class="form-control" onchange="changeServiceForm(this.value);" disabled>
                                                  ...
                                                  <input type="hidden" name="purpose" value="{{ $applicationitem_data->purpose }}">
                                              </div>
                                          </div>
                                          <div class="form-group clearfix">
                                              <label class="col-lg-2 control-label " for="maid_id">Select Maid</label>
                                              <div class="col-lg-6">
                                                  <select id="maid_id" name="maid_id" class="form-control" disabled>
                                                    @foreach($maidinform_data as $item)
                                                        <option value="{{ $item->id }}" {{ ($applicationitem_data->maid_id==$item->id)? 'selected': '' }}>{{ $item->name }}</option>
                                                    @endforeach
                                                  </select>
                                                  <input type="hidden" name="maid_id" value="{{ $applicationitem_data->maid_id }}">
                                              </div>
                                          </div>
                                        </div>
                                      </div>
...
<!-- Part B -->
    ...
    <!-- part B1 -->                      <div style="margin-top: 40px; margin-bottom: 40px;"><h4>PART A. PARTICULARS OF FDW SELECTED</h4></div>
                                          <div class="form-group clearfix">
                                              ...
                                              <div class="col-lg-5">
                                                <select id="new_select_maid_id" name="new_select_maid_id" class="form-control" disabled>
                                                  @foreach($maidinform_data as $item)
                                                      <option value="{{ $item->id }}" {{ ($servicesItem_data->select_maid_id==$item->id)? 'selected': '' }}>{{ $item->name }}</option>
                                                  @endforeach
                                                </select>
                                                <input type="hidden" name="new_select_maid_id" value="{{ $servicesItem_data->select_maid_id }}">
                                              </div>
                                              <label class="col-lg-1 control-label " for="new_date">Date: </label>
                                              <div class="col-lg-3">
                                                  <input name="new_created_date" class="form-control datepicker" value="{{ $servicesItem_data->created_date }}">
                                              </div>
                                          </div>
                                          <div class="form-group clearfix">
    ...
    <!-- part B2 -->                      <div style="margin-top: 40px; margin-bottom: 40px;"><h4>PART B. SERVICE FEE</h4></div>
                                          ...
                                          <div class="form-group clearfix">
                                              ...
                                              <div class="col-lg-7">
                                                <input name="new_price_reg_title" class="form-control" value="{{ $servicesItem_data->price_reg_title }}">
                                              </div>
                                              <div class="col-lg-2">
                                          ...
                                          <div class="form-group clearfix">
                                              ...
                                              <div class="col-lg-7">
                                                <input name="new_price_doc_title" class="form-control" value="{{ $servicesItem_data->price_doc_title }}">
                                              </div>
                                              <div class="col-lg-2">
                                          ...
                                          <div class="form-group clearfix">
                                              ...
                                              <div class="col-lg-7">
                                                <input name="new_price_med_title" class="form-control" value="{{ $servicesItem_data->price_med_title }}">
                                              </div>
                                              <div class="col-lg-2">
                                          ...
                                          <div class="form-group clearfix">
                                              ...
                                              <div class="col-lg-7">
                                                <input name="new_price_pre_title" class="form-control" value="{{ $servicesItem_data->price_pre_title }}">
                                              </div>
                                              <div class="col-lg-2">
                                           ...
                                           <div class="form-group clearfix">
                                              ...
                                              <div class="col-lg-7">
                                                <input name="new_price_rei_title" class="form-control" value="{{ $servicesItem_data->price_rei_title }}">
                                              </div>
                                              <div class="col-lg-2">
                                           ...
                                           <div class="form-group clearfix">
                                              ...
                                              <div class="col-lg-7">
                                                <input name="new_price_hom_title" class="form-control" value="{{ $servicesItem_data->price_hom_title }}">
                                              </div>
                                              <div class="col-lg-2">
                                           ...
                                           <div class="form-group clearfix">
                                              ...
                                              <div class="col-lg-7">
                                                <input name="new_price_cou_title" class="form-control" value="{{ $servicesItem_data->price_cou_title }}">
                                              </div>
                                              <div class="col-lg-2">
                                           ...
                                           <div class="form-group clearfix">
                                              ...
                                              <div class="col-lg-7">
                                                <input name="new_price_eng_title" class="form-control" value="{{ $servicesItem_data->price_eng_title }}">
                                              </div>
                                              <div class="col-lg-2">
                                           ...
                                           <div class="form-group clearfix">
                                              ...
                                              <div class="col-lg-7">
                                                <input name="new_price_saf_title" class="form-control" value="{{ $servicesItem_data->price_saf_title }}">
                                              </div>
                                              <div class="col-lg-2">
                                                ...
                                                <tbody id="insert_row_replacement">
                                                   @for($i=0;$i<$row_costreplacement;$i++)
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center;">
                                                            <input class="form-control" name="new_price_cos_third{{ $i }}" type="number" placeholder="$" value="{{ $costreplacement_data[$i]->price_cos_second }}">
                                                        </td>
                                                    </tr>
                                                    @endfor
                                                </tbody>
    ...
    <!-- part B3 -->                      <div style="margin-top: 40px; margin-bottom: 40px;"><h4>PART C. PLACEMENT FEE</h4></div>
                                          ...
                                          <div class="form-group clearfix">
                                              ...
                                              <div class="col-lg-3">
                                                  <input name="new_price_ser" type="number" class="form-control calc_item_other" onchange="calc_fee_other();" value="{{ $servicesItem_data->price_ser }}">
                                              </div>
                                          </div>
                                          <div class="form-group clearfix">
                                              <label class="col-lg-1 control-label ">2</label>
                                              ...
                                              <div class="col-lg-3">
                                                  <input name="new_price_per" type="number" class="form-control calc_item_other" onchange="calc_fee_other();" value="{{ $servicesItem_data->price_per }}">
                                              </div>
                                          </div>
                                          <div class="form-group clearfix">
                                              ...
                                              <div class="col-lg-3">
                                                  <input name="new_price_boi" type="number" class="form-control calc_item_other" onchange="calc_fee_other();" value="{{ $servicesItem_data->price_boi }}">
                                              </div>
                                          </div>
                                          <div class="form-group clearfix">
                                            <div class="col-lg-5"></div>
    ...
    <!-- part B1 -->                      <div style="margin-top: 40px; margin-bottom: 40px;"><h4>PART A. PARTICULARS OF FDW SELECTED</h4></div>
                                          <div class="form-group clearfix">
                                              ...
                                              <div class="col-lg-5">
                                                <select id="replacement_select_maid_id" name="replacement_select_maid_id" class="form-control" readonly>
                                                  @foreach($maidinform_data as $item)
                                                      <option value="{{ $item->id }}" {{ ($servicesItem_data->select_maid_id==$item->id)? 'selected': '' }}>{{ $item->name }}</option>
                                                  @endforeach
                                                </select>
                                              ...
                                              <div class="col-lg-3">
                                                  <input name="replacement_created_date" class="form-control datepicker" value="{{ $servicesItem_data->created_date }}">
                                              </div>
                                          </div>
                                          <div class="form-group clearfix">
    ...
    <!-- part B2 -->                      <div style="margin-top: 40px; margin-bottom: 40px;"><h4>PART B. SERVICE FEE</h4></div>
                                          ...
                                          <div class="form-group clearfix">
                                              ...
                                              <div class="col-lg-7">
                                                <input name="replacement_price_reg_title" class="form-control" value="{{ $servicesItem_data->price_reg_title }}">
                                              </div>
                                              <div class="col-lg-2">
                                          ...
                                          <div class="form-group clearfix">
                                              ...
                                              <div class="col-lg-7">
                                                <input name="replacement_price_doc_title" class="form-control" value="{{ $servicesItem_data->price_doc_title }}">
                                              </div>
                                              <div class="col-lg-2">
                                          ...
                                          <div class="form-group clearfix">
                                              ...
                                              <div class="col-lg-7">
                                                <input name="replacement_price_med_title" class="form-control" value="{{ $servicesItem_data->price_med_title }}">
                                              </div>
                                              <div class="col-lg-2">
                                          ...
                                          <div class="form-group clearfix">
                                              ...
                                              <div class="col-lg-7">
                                                <input name="replacement_price_pre_title" class="form-control" value="{{ $servicesItem_data->price_pre_title }}">
                                              </div>
                                              <div class="col-lg-2">
                                          ...
                                          <div class="form-group clearfix">
                                              ...
                                              <div class="col-lg-7">
                                                <input name="replacement_price_rei_title" class="form-control" value="{{ $servicesItem_data->price_rei_title }}">
                                              </div>
                                              <div class="col-lg-2">
                                          ...
                                          <div class="form-group clearfix">
                                              ...
                                              <div class="col-lg-7">
                                                <input name="replacement_price_hom_title" class="form-control" value="{{ $servicesItem_data->price_hom_title }}">
                                              </div>
                                              <div class="col-lg-2">
                                          ...
                                          <div class="form-group clearfix">
                                              ...
                                              <div class="col-lg-7">
                                                <input name="replacement_price_cou_title" class="form-control" value="{{ $servicesItem_data->price_cou_title }}">
                                              </div>
                                              <div class="col-lg-2">
                                          ...
                                          <div class="form-group clearfix">
                                              ...
                                              <div class="col-lg-7">
                                                <input name="replacement_price_eng_title" class="form-control" value="{{ $servicesItem_data->price_eng_title }}t">
                                              </div>
                                              <div class="col-lg-2">
                                          ...
                                          <div class="form-group clearfix">
                                              ...
                                              <div class="col-lg-7">
                                                <input name="replacement_price_saf_title" class="form-control" value="{{ $servicesItem_data->price_saf_title }}">
                                              </div>
                                              <div class="col-lg-2">
...
@section('custom-scripts')
    @include('js.admin.editApplication');
@stop
