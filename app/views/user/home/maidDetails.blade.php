      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
              ...
              <div class="row">
                  <div class="col-lg-12">
                      <!--progress bar start-->
                      <section class="panel" style="background-color: #f0f3f5;">
                              <div class="panel-body" style="text-align: right;">
                                    <input type="button" class="btn btn-success" value="Back" name="backButton" style="color: #ffffff!important;">
                              </div>
    ...
    <!-- Personal Information -->       <div class="col-lg-8">
                                          ...
                                          <div class="form-group clearfix">
                                              ...
                                              <div class="col-lg-10">
                                                  ...
                                                  <div class="col-lg-3">
                                                    <input type="text" class="form-control" id="birthday_month" name="birthday_month" readonly value="{{ $maidinformItem_data->birthday_month }}">
                                                  </div>
                                                  <div class="col-lg-1"><label class="subtitle_text">/</label></div>
                                                  <div class="col-lg-3">
...
<!-- Part C -->
    ...
    <!-- Employment History Overseas -->
                                          ...
                                          <div class="form-group clearfix">
                                              ...
                                              <div class="col-lg-2">
                                                  <input id="basic_salary" name="basic_salary" type="number" class="form-control" readonly value="{{ $maidinformItem_data->basic_salary }}">
                                              </div>
                                              <label class="col-lg-3 control-label " style="padding-left: 0px;">USD</label>
                                          </div>
